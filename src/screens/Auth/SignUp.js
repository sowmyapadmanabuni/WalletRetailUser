        ...
        <View>   
             ...
             <View style={{marginTop:70,marginLeft:50}}>
                ...
                <View style ={{flexDirection:'row'}}>
                 <TouchableOpacity style ={{marginTop:'4%',borderBottomWidth:1,borderBottomColor:'#B5B5B5'}} 
                    onPress={() => {  
                    this.setState({ visible: true})
                    }}>
                        <Text>+{this.state.callingCode}</Text>
                    </TouchableOpacity>
                <TextInput style={{...styles.TextInputStyle,width:"75%"}}
                ...
                <Text style={{marginTop:15}}>Email ID</Text>
                <TextInput style={styles.TextInputStyle}
                ...
                <Button style={{marginTop:30,width:"80%",color:base.theme.colors.white}}
                title="SIGN UP"
                onPress ={()=>{
